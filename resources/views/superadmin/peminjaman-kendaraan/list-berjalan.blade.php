...
@section('content')
  <div class="card">
    <div class="card-header">
      <h3 class="card-title">List Berjalan</h3>
      <span>Halaman untuk melihat dan men selesaikan peminjaman</span>
    </div>
    <div class="card-body">
      <div class="table-responsive">
        <table class="table tableBerjalan" data-route="{{ route('superadmin.peminjaman-kendaraan.datatable-berjalan') }}">
          <thead>
            <tr>
              <th>#</th>
              <th>Peminjam</th>
