...
<div class="modal-footer">
  <button class="btn btn-success btn-submit"
    data-route="{{ route('superadmin.peminjaman-kendaraan.selesai', $peminjaman->id) }}">Selesai</button>
</div>
          ...
          $.ajax({
            ...
            success: function(res) {
              window.location.href =
                "{{ route('session-message') }}?type=success&message=Sukses+Menyelesaikan+Peminjaman!"
            },
            error: function(err) {
              window.location.href =
                "{{ route('session-message') }}?type=error&message=Gagal+Menyelesaikan+Peminjaman!"
            }
          });
        }
      });
